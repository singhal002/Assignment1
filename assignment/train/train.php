...
<style>
h1 {color:blue;font-family:aerial;}
h4 {color:Red;font-family:aerial;}
	body
	{
...
<table border=1 cellspacing=10 width="100%">
	<center><b><h1>BOOK TRAIN TICKETS</h1></b></center><br>
<caption> <input type="text" name="atrain" value="FROM"> <b>---><b> <input type="text" name="rtrain" value="TO"><br><br>
<input type="date" name="date" value="enter the date"><br> <br><h4>Train class type: General</h4><input type="checkbox" name="classtype" value="general"> <h4>AC tier1</h4><input type="checkbox" name="classtype" value="ac tier1"><h4> AC tier2</h4><input type="checkbox" name="classtype" value="ac tier2"> <h4>Sleeper</h4><input type="checkbox" name="classtype" value="sleeper"> </caption>
